...
//
// --af /Users/dbpiening/git/BitDriveOS/ports/rp2/boards/rp2_af.csv
// --board /Users/dbpiening/git/BitDriveOS/ports/rp2/boards/PICO_W/pins.csv
// --prefix /Users/dbpiening/git/BitDriveOS/ports/rp2/boards/rp2_prefix.c
...
STATIC const mp_rom_map_elem_t pin_board_pins_locals_dict_table[] = {
  ...
  #if (MICROPY_HW_PIN_EXT_COUNT > 0)
  { MP_ROM_QSTR(MP_QSTR_WL_GPIO0), MP_ROM_PTR(&pin_EXT_GPIO0) },
  #endif
  #if (MICROPY_HW_PIN_EXT_COUNT > 1)
  { MP_ROM_QSTR(MP_QSTR_WL_GPIO1), MP_ROM_PTR(&pin_EXT_GPIO1) },
  #endif
  #if (MICROPY_HW_PIN_EXT_COUNT > 2)
  { MP_ROM_QSTR(MP_QSTR_WL_GPIO2), MP_ROM_PTR(&pin_EXT_GPIO2) },
  #endif
  #if (MICROPY_HW_PIN_EXT_COUNT > 0)
  { MP_ROM_QSTR(MP_QSTR_LED), MP_ROM_PTR(&pin_EXT_GPIO0) },
  #endif
};
