...
#undef MODULE_DEF_MP_QSTR__RP2
#define MODULE_DEF_MP_QSTR__RP2 { MP_ROM_QSTR(MP_QSTR__rp2), MP_ROM_PTR(&mp_module_rp2) },
...
#undef MODULE_DEF_MP_QSTR__WEBREPL
#define MODULE_DEF_MP_QSTR__WEBREPL { MP_ROM_QSTR(MP_QSTR__webrepl), MP_ROM_PTR(&mp_module_webrepl) },
...
#undef MODULE_DEF_MP_QSTR_LWIP
#define MODULE_DEF_MP_QSTR_LWIP { MP_ROM_QSTR(MP_QSTR_lwip), MP_ROM_PTR(&mp_module_lwip) },
...
#undef MODULE_DEF_MP_QSTR_UCRYPTOLIB
#define MODULE_DEF_MP_QSTR_UCRYPTOLIB { MP_ROM_QSTR(MP_QSTR_ucryptolib), MP_ROM_PTR(&mp_module_ucryptolib) },
...
#define MODULE_DEF_MP_QSTR_USOCKET { MP_ROM_QSTR(MP_QSTR_usocket), MP_ROM_PTR(&mp_module_lwip) },

extern const struct _mp_obj_module_t mp_module_ussl;
#undef MODULE_DEF_MP_QSTR_USSL
#define MODULE_DEF_MP_QSTR_USSL { MP_ROM_QSTR(MP_QSTR_ussl), MP_ROM_PTR(&mp_module_ussl) },
...
#undef MODULE_DEF_MP_QSTR_UWEBSOCKET
#define MODULE_DEF_MP_QSTR_UWEBSOCKET { MP_ROM_QSTR(MP_QSTR_uwebsocket), MP_ROM_PTR(&mp_module_uwebsocket) },
